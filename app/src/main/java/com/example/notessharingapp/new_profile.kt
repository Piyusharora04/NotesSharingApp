...
//    private lateinit var levelText : String
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPref.getString("username",null)?.let{
            val intent = Intent(this, MainActivity::class.java)
            intent.putExtra("keyVariableValue1", it)
            intent.putExtra("keyVariableValue2", sharedPref.getString("contact",""))
        ...
        continue_button.setOnClickListener {
            ...
            editor.putString("contact", contact.text.toString())
            editor.putString("field", field.text.toString())
            editor.apply()
            ...
            intent.putExtra("keyVariableValue3", fieldText)
            startActivity(intent)
        }
    }
}